import React from 'react';import { BsThreeDotsVertical } from "react-icons/bs";
...
const Friends = () => {
  return (
    <div>
      ...
      <div className="w-[447px] px-5 pb-[13px] h-[350px] shadow-lg rounded-[20px] overflow-y-scroll scrollbar-hide">
